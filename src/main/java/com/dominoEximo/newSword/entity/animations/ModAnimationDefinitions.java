...
public class ModAnimationDefinitions {
    ...
    public static final AnimationDefinition SNAKE_MOVE = AnimationDefinition.Builder.withLength(2.5417F)
        ...
        public static final AnimationDefinition SNAKE_IDLE = AnimationDefinition.Builder.withLength(2.5417F)
                .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.3583F, KeyframeAnimations.posVec(1.3F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.6417F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition SNAKE_ATTACK = AnimationDefinition.Builder.withLength(3.0833F)
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        public static final AnimationDefinition MIMIC_ATTACK = AnimationDefinition.Builder.withLength(2.0F)
                .addAnimation("upper_part", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0F, KeyframeAnimations.degreeVec(-45.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .addAnimation("upper_part", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        public static final AnimationDefinition MIMIC_MOVE = AnimationDefinition.Builder.withLength(2.0F)
